#+TODO: TOBLOG(t) OUTLINED(o) DRAFTED(d) STARTED(s) EDITED(e) DELEGATED(g) SOMEDAY(>) | DONE(x) CANCELLED(c) 
...
*** TOBLOG Learning the Colemak keyboard layout
- Background
...
*** SOMEDAY Write about planning for reasonable safety 						 :@writing:
...
** Self-tracking
*** TOBLOG Blog about user-visible improvements, Beeminder commit goal    
...
** TOBLOG Best tools for pay-what-you-can digital goods 					 :delegate:
Gumroad
...
** TOBLOG Improve your writing skills by copying other people
